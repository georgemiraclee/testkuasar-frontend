...
const Countries = () => {
  ...
  const filteredCountries = data && data.countries.filter((country: CountriesProps) => country.name.toLowerCase().includes(search.toLowerCase()));
              ...
              <Link to={`/country/${country.code}`}>
                <div>
                  ...
                  <div className="country_information">
                    <p>Capital : {country.capital === null ? "-" : country.capital}</p>
                    <p>Currency : {country.currency === null ? "-" : country.currency}</p>
                  </div>
                </div>
              </Link>
            </div>
